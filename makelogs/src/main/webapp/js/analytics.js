(function() {
	...
	var tracker = {
		...
		clientConfig : {
            ...
            //serverUrl : "http://localhost/log.gif",
		...
		columns : {
			// 发送到服务器的列名称
			eventName : "en",//事件名称, eg: e_pv e_l e_crt  e_e
		...
		onPageView : function() {
			...
			if (this.preCallApi()) {
				...
				var pageviewEvent = {};
				pageviewEvent[this.columns.eventName] = this.keys.pageView;//en=e_pv
		...
		/**
		 * 产生uuid
		 * 12BF4079-223E-4A57-AC60-C1A04D8F7A2F
		 */
		generateId : function() {
